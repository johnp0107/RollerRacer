...
public:
	...
	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UTextBlock> AIRacerNumberTextBlock;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TArray<TObjectPtr<UTextBlock>> RaceSelectionTextList;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget))
	TObjectPtr<UTextBlock>NumberOfAIPlayers;
	...
	void HighlightRaceSelectionText(int32 TextToHighlight);
